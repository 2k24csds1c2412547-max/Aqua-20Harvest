  ...
  const features = [
    {
      ...
      description: "Advanced algorithms analyze your property's specific characteristics for accurate recommendations."
    },
    {
      icon: Users,
      title: "Community Focused",
      description: "Designed to promote public participation in groundwater conservation efforts across India."
    },
    {
      icon: TrendingUp,
      title: "Data-Driven",
      description: "GIS-based models provide reliable feasibility analysis and sizing recommendations."
    },
    {
      icon: Leaf,
      title: "Environmental Impact",
      description: "Comprehensive sustainability metrics to showcase your contribution to water conservation."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Input basic information about your location, household, and property details."
    },
    {
      step: 2,
      title: "GIS Analysis",
      description: "Our system analyzes rainfall patterns, geological data, and local water characteristics."
    },
    {
      step: 3,
      title: "Calculation",
      description: "Advanced algorithms compute harvest potential, system sizing, and cost estimates."
    },
    {
      step: 4,
      title: "Recommendations",
      description: "Receive personalized recommendations with implementation guidelines."
    }
  ];
    ...
    <div className="space-y-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our platform empowers individuals and communities to assess, plan, and implement 
            rooftop rainwater harvesting systems for sustainable water management and groundwater conservation.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Rooftop Rainwater Harvesting (RTRWH) is a sustainable practice of collecting and storing 
                  rainwater from rooftops for various uses including drinking, domestic purposes, and groundwater recharge.
                </p>
                <p>
                  This ancient practice, modernized with today's technology, provides an efficient solution 
                  to water scarcity while reducing the burden on existing water infrastructure.
                </p>
                <p>
                  Our platform makes it easy for anyone to assess the feasibility and potential of 
                  implementing RTRWH systems at their location, promoting widespread adoption of this 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our advanced platform combines cutting-edge technology with proven methodologies 
            to deliver accurate, actionable insights for your rainwater harvesting project.
          </p>
        </div>
      ...
      <section className="bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures you get accurate, comprehensive results 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Implementing a rooftop rainwater harvesting system brings multiple benefits 
          ...
          <div className="space-y-6">
            <Card className="border-none shadow-lg bg-gradient-to-br from-water-50 to-water-100">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-water-600 mb-2">40%</div>
                <div className="text-gray-700">Average reduction in water bills</div>
              </CardContent>
            </Card>
            
            <Card className="border-none shadow-lg bg-gradient-to-br from-nature-50 to-nature-100">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-nature-600 mb-2">60%</div>
            ...
            <Card className="border-none shadow-lg bg-gradient-to-br from-earth-50 to-earth-100">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold text-earth-600 mb-2">3-5 years</div>
          ...
          <CardContent className="p-12 text-center relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join thousands of households already contributing to water conservation. 
                Start your RTRWH assessment today and take the first step towards sustainable water management.
              </p>
